...
Raids and similar activities would be geared towards a multiplayer experience. You can enter a queue to do these activities. These raids would have level caps to run them. Once a level is hit you gain access to all dungeons and later on all raids.
